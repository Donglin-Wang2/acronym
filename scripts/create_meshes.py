...
GRASPDIR = "/home/donglin/Data/acronym/grasps/"
OBJDIR = "/home/donglin/Data/ShapeNetSem.v0/models-OBJ/"
MANIFOLD_PATH = "/home/donglin/Github/Manifold/build/manifold"
SIMPLIFY_PATH = "/home/donglin/Github/Manifold/build/simplify"
...
def process_hash(h):
    ...
    temp_name = f"./temps/temp.{h}.watertight.obj"
    completed = subprocess.run(["timeout", "-sKILL", "90", MANIFOLD_PATH, obj, temp_name], stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
